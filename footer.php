			...
			<div class="container-inner">
				...
				<div class="pad group">
					...
					<div class="grid one-half">
						...
						<div id="credit">
							<p><?php esc_html_e('Powered by','squareread'); ?> <a href="<?php esc_url( __( 'https://wordpress.org', 'squareread' ) ); ?>" rel="nofollow">WordPress</a>. <?php esc_html_e('Theme by','squareread'); ?> <a href="http://alx.media" rel="nofollow">Alx</a>.</p>
						</div><!--/#credit-->
						<?php endif; ?>
